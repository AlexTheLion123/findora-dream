...
/**
 * @dev This contract implements the ERC-20 liquidity token. It is similar to the OpenWhisk ERC-20 contract. The difference lies in the permit functionality.
 */
contract UniswapV2ERC20 is IUniswapV2ERC20 {
    ...
    function _transfer(
        ...
        uint256 senderBalance = balanceOf[from]; // gas savings
