...
/**
 @dev removed duplicate declarations that were already included in UniswapV2ERC20.
 These duplicate declarations cause issues with multiple inheritance in newer versions of solidity.
 */

abstract contract IUniswapV2Pair is UniswapV2ERC20 {
