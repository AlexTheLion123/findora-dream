...
import {
    ...
    UniswapV2LiquidityMathLibrary, UniswapV2OracleLibrary, UniswapV2Pair, UniswapV2Router02, UQ112x112, TokenFactory
...
deploy({ network: 'http://localhost:8545', privateKey, noConfirm:true }, () => {
    ...
    let factory = contract('UniswapV2Factory', UniswapV2Factory, ['0xd8fbe0E6876C70784253af76e5CC6422C8c28f9c'])
